...
import { parse1001TracklistHtml, parseTracklistText, isUnreleasedTrack } from "./tracklist-parser.js";
...
export async function fetchReal1001Tracklist(url, options = {}) {
  return withTimeout(runFetchReal1001Tracklist(url, options), 60000, "1001TL 真实浏览器抓取");
}
...
export async function searchReal1001Tracklists(query, options = {}) {
  return withTimeout(runSearchReal1001Tracklists(query, options), 45000, "1001TL 真实浏览器搜索");
}
